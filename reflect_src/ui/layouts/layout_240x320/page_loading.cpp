...
void PageLoading240x320::create(lv_obj_t* parent) {
    _W = 320; _H = 240;
    ...
    LOG_D("PageLoading240x320: created");
}

void PageLoading240x320::_create_dynamic(lv_obj_t* parent) {
    // ©¤©¤ Progress bar ©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤
    _bar_progress = lv_bar_create(parent);
    lv_obj_set_size(_bar_progress, 280, 20);
    ...
    lv_obj_set_width(_lb_details, 300);
