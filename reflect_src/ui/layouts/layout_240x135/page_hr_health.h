...
protected:
    void _create_dynamic(lv_obj_t* parent) override {
        ...
        lv_obj_set_style_text_font(_lb_hashrate, &lv_font_montserrat_28, 0);
        ...
        lv_obj_set_style_text_font(_lb_efficiency, &lv_font_montserrat_14, 0);
        ...
        lv_obj_set_style_text_font(_lb_shares, &lv_font_montserrat_14, 0);
        ...
        lv_obj_set_style_text_font(_lb_best_diff, &lv_font_montserrat_14, 0);
