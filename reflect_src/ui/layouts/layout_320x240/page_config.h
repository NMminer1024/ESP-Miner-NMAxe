...
protected:
    void _create_dynamic(lv_obj_t* parent) override {
        ...
        lv_obj_set_style_text_font(_lb_ssid, &lv_font_montserrat_16, 0);
        ...
        lv_obj_set_style_text_font(_lb_ip, &lv_font_montserrat_16, 0);
        ...
        lv_obj_set_style_text_font(_lb_timeout, &lv_font_montserrat_16, 0);
