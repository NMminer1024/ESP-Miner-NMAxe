...
protected:
    ...
    void _create_dynamic(lv_obj_t* parent) override {
        ...
        lv_coord_t y = 20 + 40;
        _lb_workers   = _mkrow(parent, "Workers: -",      y); y += 40;
        _lb_total_hr  = _mkrow(parent, "HR: --- ",        y); y += 40;
        _lb_best_diff = _mkrow(parent, "Best: ---",       y); y += 40;
        _lb_neighbors = _mkrow(parent, "Neighbors: -",    y); y += 40;
