...
// 4-phase board (QAxe++ Rev8.1): 0.003 Ω shunt, higher OC limit
inline AxePowerHal* create_qaxepp_4ph_power_instance(axe_pwr_enable_pin_t en_pins, axe_pwr_adc_pin_t adc_pins, uint8_t vcore_regulator_pwm_pin, uint8_t pgood, uint8_t plug) {
    //                    phase, imax,  ifault,  sample reg, tfault
    tps53647_cfg_t cfg = {4,      120,    100.0f,    0.003f,  125.0f};
    return new TPS53647Class(en_pins, adc_pins, pgood, plug, cfg);
}
