...
// -----------------------------------------------------------------------------
void csha256(const void *data, size_t len, uint8_t *hash)
{
    sha256_context ctx;
...
void csha256d(const void *data, size_t len, uint8_t *hash)
{
    csha256(data, len, hash);
    csha256(hash, SHA256_SIZE_BYTES, hash);
} // sha256d
