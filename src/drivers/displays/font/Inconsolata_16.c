 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --bpp 4 --size 16 --no-compress --stride 1 --align 1 --font Inconsolata-VariableFont_wdth,wght.ttf --range 13,32-127 --format lvgl -o Inconsolata_16.c
 ******************************************************************************/
