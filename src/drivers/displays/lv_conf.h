...
#define LV_MEMCPY_MEMSET_STD 1  /* ESP32-S3: stdlib memcpy uses PIE/SIMD 128-bit instructions automatically */
...
#define LV_DISP_DEF_REFR_PERIOD 5       /*[ms]*/ /* reduced from 16ms → 5ms to minimize GIF frame latency jitter */
...
#define LV_ATTRIBUTE_FAST_MEM IRAM_ATTR  /* ESP32-S3: put LVGL hot loops in IRAM so stratum/mining I-cache pressure doesn't stall GIF decode */
