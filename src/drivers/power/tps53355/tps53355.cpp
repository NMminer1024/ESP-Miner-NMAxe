...
TPS53355Class::~TPS53355Class(){

}

void TPS53355Class::hw_init(void){
...
bool TPS53355Class::is_vcore_ready(void){
...
bool TPS53355Class::is_dc_pluged(void){
...
void TPS53355Class::set_vcore_voltage(uint16_t req_mv){
    uint16_t pwm = 0;
    //pwm = 0.14*req_mv - 140
...
uint32_t TPS53355Class::get_vcore(void){
