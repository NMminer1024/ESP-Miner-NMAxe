...
void PageClock320x240::_create_dynamic(lv_obj_t* parent) {
    _lb_hr = make_clock_label(parent, &ds_digib_font_56, 0xEE7D30, LV_ALIGN_TOP_LEFT, 0, 0, " ");
    _lb_hr_unit = make_clock_label(parent, &ds_digib_font_20, 0x808080, LV_ALIGN_TOP_LEFT, 100, 26, " ");
    _lb_hits = make_clock_label(parent, &ds_digib_font_56, 0xEE7D30, LV_ALIGN_TOP_RIGHT, -30, 0, " ");
    _lb_hits_unit = make_clock_label(parent, &ds_digib_font_20, 0x808080, LV_ALIGN_TOP_LEFT, 280, 26, "hits");
    _lb_time = make_clock_label(parent, &ds_digib_font_120, 0xFFFFFF, LV_ALIGN_CENTER, 0, 0, "--:--");
    _lb_ampm = make_clock_label(parent, &lv_font_montserrat_20, 0xFFFFFF, LV_ALIGN_CENTER, 0, 15, "");
